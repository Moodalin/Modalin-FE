...
export function BrandMark({ inverse = false }: { inverse?: boolean }) {
  return <Link to="/" className={cn('inline-flex items-center gap-2 text-[17px] font-bold tracking-[-.05em] text-primary', inverse && 'text-white')} aria-label="Beranda Modalin"><img src="/logo.svg" alt="" className={cn('h-6 w-auto', inverse && 'brightness-0 invert')} />Modalin</Link>
}
