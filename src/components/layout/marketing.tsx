...
import { ChevronDown, FolderKanban, LayoutDashboard, LogOut, Menu, ReceiptText, Store, UserRound, X } from 'lucide-react'
...
export function MarketingHeader() {
  ...
  useEffect(() => {
    ...
    getProfile().then((profile) => { if (current) setIsCreator(profile.role === 'ARTISAN' || profile.role === 'ADMIN') }).catch(() => { if (current) setIsCreator(false) })
